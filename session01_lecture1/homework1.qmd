...
IK Comment: The task is not clear in terms these conditions are AND or OR. I assume that these are separate conditions. Otherwise, it would not make sense.
...
The lowest proportion of cancelled flights is November. The weather is still good, no snow. not too cold and not too hot. The largest fraction of cancelations fall on February. The main reason is probably weather, and snow in particular. 
<!-- -->
